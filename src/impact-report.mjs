...
- Verifizierte Packs/Handoffs/Prompts/Tasks: ${formatNumber(quality.verified_packs)}/${formatNumber(report.ledgers.savings.entries)} Packs, ${formatNumber(quality.verified_handoffs)}/${formatNumber(report.ledgers.handoff.entries)} Handoffs, ${formatNumber(quality.verified_prompt_preparations)}/${formatNumber(report.ledgers.prompt_preparation.entries)} Prompts, ${formatNumber(quality.verified_tasks)}/${formatNumber(report.ledgers.task_outcome.entries)} Tasks
